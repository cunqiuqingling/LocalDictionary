...
void testProductionDefaults() {
  ...
  require(l.maximumRecordBlockInfoBytes == UINT64_C(524288), "default record info bytes");
  require(l.maximumRecordBlockCount == UINT64_C(16384), "default record block count");
  require(l.maximumSingleRecordBlockCompressedBytes == UINT64_C(1048576), "default single record compressed");
  require(l.maximumSingleRecordBlockDecompressedBytes == UINT64_C(8388608), "default single record decompressed");
  require(l.maximumTotalRecordBlockCompressedBytes == UINT64_C(268435456), "default total record compressed");
  require(l.maximumTotalRecordBlockDecompressedBytes == UINT64_C(1073741824), "default total record decompressed");
  require(l.maximumRecordRangeBytes == UINT64_C(524288), "default record range");
  require(l.maximumReturnedRecordBytes == UINT64_C(524288), "default returned record");
